...
<head>
    ...
    <title>KNS School</title>
</head>
<body>

        <div class="studet deatails">
            <div class="student text-center py-5 ">
                <h2 class="text-light">Student Details System</h2>
                <button class="btn btn-outline-light mt-3 py-2 fw-bold px-5">Click Here >></button>
            </div>
