...
<div id="carouselExampleCaptionsFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
      ...
      <div class="carousel-item active">
          <img src="assets/images/banner19.png" class="d-block w-100" alt="...">
          <div class="carousel-caption align-items-center  mb-5 pb-5">
              <h5 class="">First slide label</h5>
              <p class="pt-2 pb-5">Some representative placeholder content for the first slide.</p>
          </div>
      </div>
      <div class="carousel-item ">
          <img src="assets/images/banner18.png" class="d-block w-100" alt="...">
          <div class="carousel-caption align-items-center  mb-5 pb-5">
              <h5 class="">First slide label</h5>
              <p class="pt-2 pb-5">Some representative placeholder content for the first slide.</p>
          </div>
      ...
      <div class="carousel-item" >
          <img src="assets/images/banner120.png" class="d-block w-100" alt="...">
          <div class="carousel-caption align-items-center  mb-5 pb-5">
              <h5 class="">First slide label</h5>
              <p class="pt-2 pb-5">Some representative placeholder content for the first slide.</p>
          </div>
